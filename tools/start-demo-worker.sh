...
export SCAN_PROCESSING_QUEUE_NAME="${SCAN_PROCESSING_QUEUE_NAME:-hera:scan:processing:mock}"
export NAMADA_DECODER_COMMAND="${NAMADA_DECODER_COMMAND:-$PWD/tools/mock-namada-empty-decoder.sh}"
